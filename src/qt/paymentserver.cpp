...
const QString BITCOIN_IPC_PREFIX("malaysiacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click malaysiacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start malaysiacoin: click-to-pay handler");
    else
...
{
    // clicking on malaysiacoin: URLs creates FileOpen events on the Mac:
