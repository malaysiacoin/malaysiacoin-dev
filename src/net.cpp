...
static const char *strTestNetDNSSeed[][2] = {
    {"malaysiacoin.info", "malaysiacoin.info"},
	{"malaysiacoin.org", "server1.malaysiacoin.org"},
	{"malaysiacoin.com", "malaysiacoin.com"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MalaysiaCoin is probably already running."), addrBind.ToString().c_str());
        else
